...
//LCD背光引脚
#define LCD_BL_GPIO_CLK()	__HAL_RCC_GPIOD_CLK_ENABLE();
#define LCD_BL_GPIO_PORT	GPIOD
#define LCD_BL_GPIO_PIN		GPIO_PIN_13
#define LCD_BL(x)	if(x){_SET_PIN(LCD_BL_GPIO_PORT,LCD_BL_GPIO_PIN);}else _RESET_PIN(LCD_BL_GPIO_PORT,LCD_BL_GPIO_PIN)
